...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xcmocean-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13022&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xcmocean-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xcmocean` can be installed with:

```
conda install xcmocean
```

It is possible to list all of the versions of `xcmocean` available on your platform with:
